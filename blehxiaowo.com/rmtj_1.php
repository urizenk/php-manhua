...
$articles = [
    ...
    [
        'url' => ' https://caiyun.139.com/w/i/2nc6qRCZxwwsv',
    ...
    [
        'url' => 'https://caiyun.139.com/w/i/2nc6qRCZxwDe8', // 根据关键词“人鱼”更新
    ...
    [
        'url' => 'https://uwn61ldr2m3.feishu.cn/docx/TOD8dovAyot0yRx0yTfcfLornkc?from=from_copylink', // 根据关键词“甜美的”更新
...
<body>
    ...
    <section class="container excerpts-wrap">
        ...
        <?php else: ?>
        <div id="noResults" style="text-align: center; padding: 20px; color: #D3D3D3;">
